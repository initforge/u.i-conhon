...
const UserProfilePage: React.FC = () => {
    ...
    const [formData, setFormData] = useState({
        ...
        accountHolder: user?.bank_holder || '',
        bankName: user?.bank_code || '',
    });
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="p-4 bg-gray-50 rounded-lg">
                        ...
                        <p className="font-semibold text-gray-800">{user?.zalo || 'Chưa cập nhật'}</p>
                    </div>
                </div>
            </div>
                ...
                {isEditing && (
                    <div className="flex space-x-3 mt-6">
                        <button
                            onClick={handleSave}
                            disabled={isSaving}
                            className="flex-1 px-6 py-3 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors duration-200 font-semibold disabled:opacity-50 disabled:cursor-not-allowed"
                        >
