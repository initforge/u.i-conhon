...
import { THAIS, ANIMALS, Order } from '../types';
...
const MyOrdersPage: React.FC = () => {
    ...
    useEffect(() => {
        ...
        const fetchOrders = async () => {
            try {
                ...
                const transformed: Order[] = (response.orders || []).map((o: any) => ({
                    id: o.id,
                    userId: o.user_id,
                    thaiId: o.thai_id || '',
    ...
    // API already returns current user's orders, no need to filter by userId
    ...
    const getThaiName = (thaiId: string) => {
        const thai = THAIS.find(t => t.id === thaiId);
