...
import { mockOrders, mockThais } from '../mock-data/mockData';
                                ...
                                <div key={order.id} className="border rounded-lg p-4 hover:bg-gray-50 transition-colors">
                                    <div className="flex justify-between items-start">
                                        <div>
                                            ...
                                            <p className="text-sm text-gray-600">{mockThais.find(t => t.id === order.thaiId)?.name || order.thaiId}</p>
